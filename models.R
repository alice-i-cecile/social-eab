...
eab_factory <- function (r=1, K=1, allee_threshold=0, transmission_rate=0,   fatality_rate=0,  social_rate=0, transport_cost=0, local_cost=0, norm_strength=0, concern_level=0, dispersal_constant=0){
